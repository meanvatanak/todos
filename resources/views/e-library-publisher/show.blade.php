...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0">Show Publisher</h1>
  </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label for="">Name:</label> <span class="text-primary" style="font-family: 'Khmer OS Battambang', sans-serif;'">{{ $publisher->name }}</span>
              </div>
            </div>
          </div>
  ...
  <div class="modal-footer">
    <a href="{!! url('/publisher') !!}" class="btn btn-secondary">Back</a>
  </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" id="update-content">
      <div class="modal-header bg-info">
        <h4 class="h4 mb-0">Show Publisher History</h4>
...
<input type="hidden" id="publisher_id" value="{{ $publisher->id }}">
  ...
  $(document).ready(function() {
    ...
    function load_data()
    {
      ...
      table = $('#dataTable2').DataTable({
        ...
        ajax: {
          type: 'GET',
          url: "{{ route('publishers-history.getDatatable') }}",
          data: {
