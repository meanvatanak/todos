...
<div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input value="{{ old('username') ? old('username') : $user->username }}" type="text" placeholder="Username" autocomplete="off"
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input data-toggle="input-mask" data-mask-format="(000) 000-0000" type="text" required
  ...
  <input type="hidden" id="hidden_role" value="{{ $user->role_id }}">
</div>
  ...
  function checkedRole()
  {
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        role.html(radio);
        $('div[id="roles"]').find('input[value="'+h_role+'"]').attr("checked",true);
        console.log(data);
